    ...
    export default {
        ...
        data() {
            return {
                ...
                exercise: [
                    [ "$tableOrders", "=", "[", 4, "=>", "[", ""Hamburger"", ",", ""Fries"", ",", ""Milkshake"", "],", 12, "=>", "[", ""Double-Cheeseburger"", ",", ""Double-Cheeselight"", ",", ""Coke"", "]", "];", 
                    "foreach", "(", "$tableOrders", "as", "$table", "=>", "$order", ")", "{", "foreach", "(", "$order", "as", "$item", ")", "{", "$burger", "=", "make(", "$item", ");", "serve(", "$table", ",", "$burger", ");", "}", "}"]
                ],
